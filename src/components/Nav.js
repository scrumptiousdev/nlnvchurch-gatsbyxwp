  ...
  render() {
    ...
    return (
      <StaticQuery
        ...
        render={data => (
          <>
            <div className={`nav__overlay${menuOpen ? ' opened' : ''}`} />
            <nav className={`nav${menuOpen ? ' opened' : ''}`}>
              <a className="js-transition nav__link nav__link-mobile" href="#" onClick={(e) => this.handleMenuToggle(e)}>
